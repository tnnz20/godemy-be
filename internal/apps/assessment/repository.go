...
type Repository interface {
	...
	FindAssessmentsByCourseId(ctx context.Context, courseId uuid.UUID, assessmentCode string, status uint8, model entities.AssessmentPagination) (assessments []entities.AssessmentUsersResult, err error)
